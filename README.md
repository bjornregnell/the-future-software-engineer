...
What happened? Thanks to the compiler, software engineers could start coding at a higher abstraction level and get more done. Did assembler programmers loose their jobs? No, but the needed to learn new things. And the had good use of their machine code knowledge men writing source code. And we still today teach about machine programming as all good software engineers need to understand what is actually happening at different abstraction levels.
